...
{
  "$end", "error", "$undefined", "T_INTEGER", "T_FLOAT", "T_IDENTIFIER",
  "T_PLUS", "T_MINUS", "T_MULTIPLY", "T_DIVIDE", "T_NOT", "T_ASSIGN",
  "T_GREATER", "T_LESS", "T_BAND", "T_BOR", "T_BXOR", "$accept", "program",
