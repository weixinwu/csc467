 ...
 ***********************************************************************/
program
  : TOKEN_GRA_CURLY_OPEN instructions TOKEN_GRA_CURLY_CLOSE {yTRACE("program -> {instructions}"); root = ast_allocate(NKIND_INSTRUCTIONS, 3, NULL,NULL,NULL); }
...
value
  :	TOKEN_VAL_FLOAT			{yTRACE("value -> float");}
  |	TOKEN_VAL_TRUE			{yTRACE("value -> true");}
  |     TOKEN_VAL_FALSE			{yTRACE("value -> false");}
  |     TOKEN_VAL_INTEGER		{yTRACE("value -> integer");}
  |     TOKEN_VAL_IDENTIFIER index	{yTRACE("value -> identifer");}
  ;
...
assignment
  ...
  | TOKEN_VAL_IDENTIFIER index TOKEN_ASSIGN TOKEN_GRA_CURLY_OPEN expression TOKEN_GRA_COMMAR expression TOKEN_GRA_CURLY_CLOSE {yTRACE("assignment -> identifier index = expression (vec2)");}
  | TOKEN_VAL_IDENTIFIER index TOKEN_ASSIGN TOKEN_GRA_CURLY_OPEN expression TOKEN_GRA_COMMAR expression TOKEN_GRA_COMMAR expression TOKEN_GRA_CURLY_CLOSE  {yTRACE("assignment -> identifier index = expression (vec3)");}
  | TOKEN_VAL_IDENTIFIER index TOKEN_ASSIGN TOKEN_GRA_CURLY_OPEN expression TOKEN_GRA_COMMAR expression TOKEN_GRA_COMMAR expression TOKEN_GRA_COMMAR expression TOKEN_GRA_CURLY_CLOSE {yTRACE("assignment -> identifier index = expression (vec4)");}
  ;
